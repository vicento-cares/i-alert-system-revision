...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2024 at 01:16 AM
...
CREATE TABLE `ialert_audit` (
  ...
  `audit_category` varchar(255) DEFAULT NULL,
...
--
-- Table structure for table `ialert_daily_report`
--

CREATE TABLE `ialert_daily_report` (
...
--
-- Indexes for table `ialert_daily_report`
--
ALTER TABLE `ialert_daily_report`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ialert_daily_report`
--
ALTER TABLE `ialert_daily_report`
