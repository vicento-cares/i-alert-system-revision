<div class="modal fade bd-example-modal-xl" id="other_group" tabindex="-1"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">
            <div><h3><b>Other Group</b></h3>
               <div class="col-sm-12">
              <div class="row">
                    <div class="col-5">
                <label for="">Audited Date From:</label> <input type="date" id="otherdatefrom" class="form-control" value="<?=$server_month;?>" autocomplete=off>
                    </div>
                    <div class="col-5">
                <label for="">Audited Date To:</label>  <input type="date" id="otherdateto" class="form-control" value="<?=$server_date_only;?>" autocomplete=off> 
                  </div>
                  <div class="col-2">
                ...
                <div class="col-2">
                 ...
                 <div class="col-2">
                    <span>Other Group:</span>
                     <select class="form-control" name="other_prev" id="other_prev">
...
<button class="btn btn-info" data-toggle="modal" data-target="#count">Audit&nbsp;Count</button>&nbsp;    <button class="btn btn-danger" onclick="delete_other()">Delete</button>                
    </div>
           </div>
      </div>
