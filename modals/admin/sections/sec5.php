        ...
        <h5 class="modal-title" id="exampleModalLabel">
          <div>
            ...
            <div class="col-sm-12">
              <div class="row">
                <div class="col-5">
                  <label for="auditedsec5datefrom">Audited Date From:</label> <input type="date" id="auditedsec5datefrom"
                    class="form-control" value="<?= $server_month; ?>" autocomplete=off>
                </div>
                <div class="col-5">
                  <label for="auditedsec5dateto">Audited Date To:</label> <input type="date" id="auditedsec5dateto" class="form-control"
