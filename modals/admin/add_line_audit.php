  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
           ...
           <div class="row">
                <div class="col-3">
                     <span> Car Maker:   </span> <input type="text" list="list" id="carmaker_line" class="form-control-lg" autocomplete="OFF" class="noSpace">
                      <datalist id="list">
                  <option value="Suzuki">
                  <option value="Toyota">
                  <option value="Mazda">
       ...
       <option value="">Select Line</option>
        ...
        ?>
         ...
         <div class="row">
            <div class="col-3">
                   <span>Group:</span>
                   <select class="form-control" name="falp_group_line" id="falp_group_line" onchange="fetch_section_dropdown()">
