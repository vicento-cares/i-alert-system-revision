                ...
                <div class="row">
                  <div class="col-lg-4 col-6">
                    ...
                    <div class="small-box bg-info">
                      <div class="inner">
                        <a href="" style="color:white;" data-toggle="modal" data-target="#line_audit"
                          onclick="create_line_audit()">
                      ...
                      <a href="#" class="small-box-footer" data-toggle="modal" data-target="#line_audit"
                        onclick="create_line_audit()">Proceed <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-6">
                    ...
                    <div class="small-box bg-secondary">
                      ...
                      <a href="#" class="small-box-footer" data-toggle="modal" data-target="#import_line_audit">Proceed
                  ...
                  <div class="col-lg-4 col-6">
                    ...
                    <div class="small-box bg-primary">
                      ...
                      <a href="../../template/list_of_lines_audit_findings_template.csv"
                        class="small-box-footer">Proceed <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                  </div>
