        ...
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <div class="row">
                <div class="col-6">
                  <label for="hrauditedlistdatefrom">Audited Date From:</label> <input type="date" id="hrauditedlistdatefrom"
                    class="form-control" value="<?= $server_month; ?>" autocomplete=off>
                </div>
                <div class="col-6">
                  <label for="hrauditedlistdateto">Audited Date To:</label> <input type="date" id="hrauditedlistdateto"
                ...
                <h3 class="card-title">
                  <div class="row">
                    ...
                    <div class="col-3">
                      ...
                      <input list="lines" id="linename_audited_fass_checking" name="linename_audited_fass_checking"
                        class="form-control">
                    ...
                    <div class="col-3">
                      <span for="">Position:</span> <select id="position_checking" class="form-control"
                        autocomplete=off>
                  ...
                  <div class="row">
                    <div class="col-4">
                      <span>Car Maker: </span>
                      <input type="text" list="list" name="carmaker" id="carmaker_checking" class="form-control">
                      <datalist id="list">
                        <option value="Suzuki">
                        <option value="Toyota">
                        <option value="Mazda">
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 100px;">
                    <button class="btn btn-primary" id="searchReqBtn"
                      onclick="load_list_of_audited_findings_hr()">Search <i class="fas fa-search"></i></button>
                        ...
                        <div class="row">
                          ...
                          <div class="col-6">
                            <button class="btn btn-success "
                              onclick="export_audited_list_hr('audited_list_data_hr')">Export</button>
