  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/i-alert/page/hr/dashboard.php") { ?>
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/i-alert/page/hr/for_checking.php") { ?>
          <a href="for_checking.php" class="nav-link active">
          <?php } else { ?>
        ...
        <li class="nav-item">
          <?php if ($_SERVER['REQUEST_URI'] == "/i-alert/page/hr/checked.php") { ?>
          <a href="checked.php" class="nav-link active">
          <?php } else { ?>
