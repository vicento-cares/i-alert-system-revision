                ...
                <h3 class="card-title">
                  ...
                  <div class="row">
                    ...
                    <div class="col-3">
                      ...
                      <input list="lines" id="linename_audited_prodivder" name="linename_audited_prodivder"
                        class="form-control">
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 100px;">
                    <button class="btn btn-primary" id="searchReqBtn"
                      onclick="load_list_of_audited_findings_provider()">Search <i class="fas fa-search"></i></button>
                        ...
                        <div class="row">
                          ...
                          <div class="col-6">
                            <button class="btn btn-success "
                              onclick="export_audited_list_provider('audited_list_data_provider')">Export</button>
