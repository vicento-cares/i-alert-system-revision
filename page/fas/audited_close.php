  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">List of Audited Closed <input type="hidden" name="falp_group" id="falp_group_closed" value="<?=$falp_group;?>"></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <div class="card-header">
                ...
                <span>Employee ID: </span>
                  ...
                  <div class="col-3">
                    ...
                    <input list="lines" id="linename_audited_fas_closed" name="linename_audited_fas_closed" class="form-control">
