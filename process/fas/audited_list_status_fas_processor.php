                    ...
                    if ($stmt2->execute()) {
                        foreach($stmt2->fetchALL() as $j){
                             ...
                             if ($audit_count >= 3 && $status != 'IR'){
                                ...
                                $update = "UPDATE ialert_audit SET edit_count = 0, pd = '$status', updated_by = '$update_by' WHERE id = '$x'";
                                ...
                                $updates = "UPDATE ialert_audit SET edit_count = 0, pd = '$status', updated_by = '$update_by' WHERE id = '$x'";
